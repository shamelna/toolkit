...
const KaizenSensei = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50">
              ...
              <div className="bg-white rounded-2xl border border-gray-200 h-[500px] flex flex-col shadow-inner">
                <div className="flex-1 overflow-y-auto p-8 flex flex-col gap-6">
                  {messages.map((message) => (
                    <div
                      key={message.id}
                      className="flex justify-end max-w-[85%] animate-fadeIn"
                  ...
                  {isLoading && (
                    <div className="flex justify-start max-w-[85%] animate-fadeIn">
      ...
      {/* Add custom styles via className instead of style jsx */}
      <div className="animate-fadeIn shadow-inner"></div>
    </div>
  );
};
